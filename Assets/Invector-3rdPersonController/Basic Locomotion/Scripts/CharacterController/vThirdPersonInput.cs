...
{  
    ...
    {       
        ...
        protected virtual void Update()
        {
            ...
            //------------------------------------------------------------------------------
            // Yuki: Only rotate camera when right mouse is down
            // Lock the mouse on right click, unlock when release.
        ...
        public virtual void UpdateCameraStates()
        {
            ...
            //------------------------------------------------------------------------------
            // Yuki: Change to drive state if the player is driving
            //------------------------------------------------------------------------------
            else if (GetComponent<Player>().GetDrivingShip() != null)
                tpCamera.ChangeState("Drive", true);
            else
